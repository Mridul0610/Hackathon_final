...
{status===3 &&(
    <button style={{backgroundColor:'rgb(14, 27, 77)',color:'white',height:'100%'}} onClick={()=> ChangeRequestStatus(eventId,4)}>
        Publish Result
    </button>
  )}
  {status===4 &&(
    <button style={{backgroundColor:'rgb(14, 27, 77)',color:'white',height:'100%' }}>
        Result Published
    </button>
  )}
</div>
